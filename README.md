...
SWAN is a software package owned by Delft University of Technology (TUD). The SWAN software can be used freely under the terms of the [GNU General Public License](https://gitlab.tudelft.nl/citg/wavemodels/swan/-/blob/main/LICENSE). TUD repository: https://swanmodel.sourceforge.io/

Repository https://github.com/Deltares-research/SWAN_TUD contains copies of SWAN produced by TUD.
...
The text below is copied from https://gitlab.tudelft.nl/citg/wavemodels/swan/-/blob/main/README.md
