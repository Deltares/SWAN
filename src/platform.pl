...
if ($os =~ /IRIX64/i) {
  ...
  print OUTFILE "  NCF_OBJS = nctablemd.o agioncmd.o swn_outnc.o HRextensions.o\n";
  print OUTFILE "else\n";
...
#    print OUTFILE "FLAGS_MSC = -W0 -assume byterecl -traceback -diag-disable remark\n";
  ...
  {
    print OUTFILE "##############################################################################\n";
    print OUTFILE "# IA32_Intel/EM64T_Intel:	Intel Pentium with MS Windows using Intel compiler 12.\n";
    print OUTFILE "##############################################################################\n";
    print OUTFILE "F90_SER = ifort\n";
    print OUTFILE "F90_OMP = ifort\n";
    print OUTFILE "F90_MPI =\n";
    print OUTFILE "FLAGS_OPT = /optimize:2\n";
    print OUTFILE "FLAGS_MSC = /nologo /warn:none /assume:byterecl /traceback\n";
    print OUTFILE "FLAGS90_MSC = \$(FLAGS_MSC)\n";
    print OUTFILE "FLAGS_SER =\n";
    ...
    print OUTFILE "INCS_MPI =\n";
    print OUTFILE "LIBSC = /link /LTCG /NODEFAULTLIB:LIBC.lib /NODEFAULTLIB:LIBCMTD.lib /NODEFAULTLIB:LIBCMT.lib msvcrt.lib\n";
    ...
    print OUTFILE "LIBS_MPI =\n";
    print OUTFILE "NCF_OBJS = nctablemd.obj agioncmd.obj swn_outnc.obj HRextensions.obj\n";
    print OUTFILE "!ELSE\n";
    print OUTFILE "INCS_SER =\n";
    print OUTFILE "INCS_OMP =\n";
    print OUTFILE "INCS_MPI =\n";
