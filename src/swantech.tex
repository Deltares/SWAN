...
rectangular grid, but also on a curvilinear grid. Previous official versions 30.62, 30.75,
...
\section{Governing equations in curvilinear co-ordinates} \label{sec:curvi}
...
\section{Computation of force in curvilinear co-ordinates}
...
\begin{equation}
  \overline{\sigma} = (w_{2} m_{1,1} + w_{1} m_{2,1})/(w_{2} m_{1,0} + w_{1} m_{2,0})
\end{equation}
...
\begin{equation}
  \overline{\theta} = \mbox{atan} [\frac{w_{2} m_{1,y} + w_{1} m_{2,y}}{w_{2} m_{1,x} + w_{1} m_{2,x}}]
\end{equation}
Finally the interpolated spectrum is calculated as follows:
\begin{equation}
  N(\sigma,\theta) = w_{2} N_{1} [\overline{\sigma}_{1} \sigma/\overline{\sigma}, \theta -
  (\overline{\theta} - {\overline{\theta}}_{1} ) ] + w_{1} N _{2} [{\overline{\sigma}}_{2} \sigma /
...
numerically on a curvilinear grid. The next section discusses the details of the
...
\label{sec:data}
After the discretization of the Poisson equation in curvilinear
...
available in both the rectilinear and curvilinear grids.
\nocite{Bot85E}
...
can be rectilinear or curvilinear. The number
...
\bibitem{Boo97HPb}
Booij, N., L.H. Holthuijsen and R. Padilla-Hernandez, 1997: Numerical wave propagation on a curvilinear
...
\bibitem{Hol97BP}
Holthuijsen, L.H., N. Booij and R. Padilla-Hernandez, 1997: A curvilinear, third-generation coastal wave
...
\addcontentsline{toc}{chapter}{Index}
  ...
  \item current, 2, 3, 7, 10--13, 15, 35, 38, 39, 43, 44, 47, 50--53,
		...
		117--119, 121
  \item curvilinear, 2, 3, 58--60, 62, 78, 84, 85, 93, 108, 113
